    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EventsExercises", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EventsExercises_Events_EventsId",
                        column: x => x.EventsId,
                        principalTable: "Events",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EventsExercises_Exercises_ExercisesId",
            ...
            migrationBuilder.InsertData(
                table: "EventsExercises",
                columns: new[] { "Id", "EventsId", "ExercisesId" },
                values: new object[,]
                {
                    { 3, 1, 11 },
                    { 1, 1, 3 },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventsExercises_EventsId",
                table: "EventsExercises",
                column: "EventsId");

            migrationBuilder.CreateIndex(
                name: "IX_EventsExercises_ExercisesId",
                table: "EventsExercises",
                column: "ExercisesId");
