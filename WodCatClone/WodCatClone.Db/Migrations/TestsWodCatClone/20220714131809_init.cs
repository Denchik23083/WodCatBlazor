    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Singlet,Bodyweight,For-Time", "Легкий", 1, "23", "G", "100 Burpees", "7.0", "20", new TimeSpan(0, 0, 0, 0, 0) },
                    { 3, "Couplet,Bodyweight,ForTime,Rower", "Нормальный", 1, "24", "GM", "Titan wod", "10.0", "00", new TimeSpan(0, 0, 0, 0, 0) },
                    { 4, "Couplet,ForTime,Kettlebell", "Нормальный", 2, "16", "WM", "Вместе Навсегда", "8.0", "25", new TimeSpan(0, 0, 0, 0, 0) },
                    { 6, "Triplet,For-Time", "Нормальный", 3, "19", "WGM", "Siberian Bears", "7.5", "00", new TimeSpan(0, 0, 0, 0, 0) },
                    { 7, "Couplet,For-Time", "Легкий", 5, "29", "WG", "08022014", "8.0", "06", new TimeSpan(0, 0, 0, 0, 0) },
                    { 2, "Couplet,Bodyweight,For-Time", "Сложный", 4, "50", "GM", "1000", "8.5", "30", new TimeSpan(0, 0, 0, 0, 0) },
                    { 5, "Endurance,Singlet,AMRAP", "Легкий", 4, "05", "M", "Jumping300", "6.5", "00", new TimeSpan(0, 0, 0, 0, 0) }
                });
