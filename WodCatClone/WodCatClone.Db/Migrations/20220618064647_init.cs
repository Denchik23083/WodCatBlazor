...
namespace WodCatClone.Db.Migrations
{
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Articles",
                columns: new[] { "Id", "ArticlesEmblemId", "Description", "FullDescription", "Name", "Rating", "Type", "UserId" },
                values: new object[,]
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 4, 0, "Тільки мікс всіх видів спорту може дати найкращі результати в фізичній підготовці. В тренуваннях використовується все найкраще з гімнастики, важкої атлетики, пауерліфтингу, боротьби, боксу, циклічних видів спорту. ГРАФІК РОБОТИ: З ПН - ПТ з 8.00 до 22.00 год. Субота з 10 до 20 год. Неділя з 10 до 18 год. КОНТАКТНІ ТЕЛЕФОНИ: 0978830270 Валерій Михайловський 0979042783 Людвіг Пухальський 0977912229 Олександр Антонюк", 5, "вулиця Свободи, 1А", "CF TITAN BOX", null, "Хмельницкий", "Crossfit (not Aff.),Gym", null }
                });
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_User_Programs_ProgramsId",
                table: "User",
                column: "ProgramsId",
                principalTable: "Programs",
                principalColumn: "Id",
