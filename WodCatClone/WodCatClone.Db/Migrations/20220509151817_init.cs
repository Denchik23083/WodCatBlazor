...
namespace WodCatClone.Db.Migrations
{
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Programs",
                columns: new[] { "Id", "Description", "HallId", "Image", "Name", "Rating", "Type" },
                values: new object[] { 2, null, null, "img/wod.png", "Plan for the amateur", null, "Кроссфит,На силу" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "I am a developer C#", new DateTime(2003, 8, 23, 0, 0, 0, 0, DateTimeKind.Unspecified), "Ukraine", "deniskudravov228@gmail.com", 1, null, "185", "Денис", "SoEasyBlef", "0000", 180, null, "Кудрявов", "Херсон", "70" });
