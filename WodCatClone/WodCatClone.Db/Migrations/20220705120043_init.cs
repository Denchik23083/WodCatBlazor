        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "img/EmblemPrograms/GymMan.png", "GymMan" },
                    { 1, "img/EmblemPrograms/BallMan.png", "BallMan" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 3, "Couplet,Bodyweight,ForTime,Rower", "Нормальный", 1, "24", "GM", "Titan wod", "10.0", "00" },
                    { 4, "Couplet,ForTime,Kettlebell", "Нормальный", 2, "16", "WM", "Вместе Навсегда", "8.0", "25" },
                    { 6, "Triplet,For-Time", "Нормальный", 3, "19", "WGM", "Siberian Bears", "7.5", "00" },
                    { 7, "Couplet,For-Time", "Легкий", 5, "29", "WG", "08022014", "8.0", "06" },
                    { 2, "Couplet,Bodyweight,For-Time", "Сложный", 4, "50", "GM", "1000", "8.5", "30" },
                    { 5, "Endurance,Singlet,AMRAP", "Легкий", 4, "05", "M", "Jumping300", "6.5", "00" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "К ТОНУС Стадион СЛАВУТИЧ АРЕНА Категории : SCALED, RX (ELITE), MASTERS 1 день 3 завдання Стартовый взнос - 500 грн Запись на участие В DIRECT!!! Для тихого, что из-за различных причин, не возможно прийняти участів в змаганнях, ми пропонуємо ОНЛАЙН ФОРМАТ. БЕЗ ВИДЕО! БЕЗ НАШЕГО СУДДІВСТВА ! ВСЕ НА НАШИЙ ДОВІРІ та ВАШІЙ ПОРЯДНОСТІ ! УМОВИ : Рестрация - 300 грн Категории - RX (ЭЛИТА) SCALED MASTERS 35 - 39, 40 - 44, 45+ 3 ( три комплекса) за один день Анонс 24.06 в п'ятницю ввечері о 17:00 Вконання 25.06 - субота . Отправить результаты до 17:00 субботы 25.06. Оголошення результатов у понедельника 27.06 Для записи напишите в DIRECT: Прізвище, им'я Місто, клуб Категорію", new DateTime(2022, 6, 30, 15, 0, 0, 0, DateTimeKind.Unspecified), 2, 1, "улица Лобановского, 21", "TONUS 2022 help UA", new DateTime(2022, 6, 27, 10, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2022, 6, 29, 12, 30, 0, 0, DateTimeKind.Unspecified), "Запорожье", "Соревнования", "Кроссфит", 1, 3 },
                    { 2, "К ТОНУС Стадион СЛАВУТИЧ АРЕНА Категории : SCALED, RX (ELITE), MASTERS 1 день 3 завдання Стартовый взнос - 500 грн Запись на участие В DIRECT!!! Для тихого, что из-за различных причин, не возможно прийняти участів в змаганнях, ми пропонуємо ОНЛАЙН ФОРМАТ. БЕЗ ВИДЕО! БЕЗ НАШЕГО СУДДІВСТВА ! ВСЕ НА НАШИЙ ДОВІРІ та ВАШІЙ ПОРЯДНОСТІ ! УМОВИ : Рестрация - 300 грн Категории - RX (ЭЛИТА) SCALED MASTERS 35 - 39, 40 - 44, 45+ 3 ( три комплекса) за один день Анонс 24.06 в п'ятницю ввечері о 17:00 Вконання 25.06 - субота . Отправить результаты до 17:00 субботы 25.06. Оголошення результатов у понедельника 27.06 Для записи напишите в DIRECT: Прізвище, им'я Місто, клуб Категорію", new DateTime(2022, 8, 30, 15, 0, 0, 0, DateTimeKind.Unspecified), 2, 1, "улица Лобановского, 21", "TONUS 2022 help UA", new DateTime(2022, 6, 27, 10, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2022, 6, 29, 12, 30, 0, 0, DateTimeKind.Unspecified), "Запорожье", "Соревнования", "Кроссфит", 1, 3 }
                });
